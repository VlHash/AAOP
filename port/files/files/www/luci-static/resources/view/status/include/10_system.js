...
return baseclass.extend({
	...
	render: function(data) {
		...
		var real_target = L.isObject(boardinfo.release) ? boardinfo.release.target : '';
		var display_target = (boardinfo.model == 'LiteLumine Cellu-AR750S')
			? 'ath79/Embstar'
			: real_target;
		...
		var fields = [
			...
			_('Target Platform'), display_target,
			_('Firmware Version'),
			...
			_('Load Average'), Array.isArray(systeminfo.load)
				? '%.2f, %.2f, %.2f'.format(
